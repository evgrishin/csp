...
//$_lang['setting_ms2_product_thumbnail_size'] = 'Розмір мініатюр за замовчуванням';
//$_lang['setting_ms2_product_thumbnail_size_desc'] = 'Тут ви можете вказати розмір зазделегідь зменшеної копії зображення для вставки поля "thumb" товару. Звичайно, цей розмір має існувати в налаштуваннях джерела медіафайлів, щоб генерувались такі мініатюри. Інакше буде логотип minIShop2 замість зображення товару в адмінці.';
